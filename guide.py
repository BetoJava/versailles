...
# Afficher le DataFrame des sommets et la matrice de passage
print("DataFrame des Sommets :")
print(vertex_df)

print("\nMatrice de Passage :")
print(passage_matrix_df)

# Sélectionner les sections à visiter en fonction du temps et des activités les plus intéressantes
selected_section = select_sections_by_interest(vertex_df, passage_matrix_df, available_time, start_time)
